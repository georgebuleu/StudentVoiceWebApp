    ...
    public partial class TestMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2022, 7, 31, 19, 33, 58, 511, DateTimeKind.Local).AddTicks(5893), "Question needs to be approved", null, false },
                    { 2, new DateTime(2022, 7, 31, 19, 33, 58, 511, DateTimeKind.Local).AddTicks(5898), "A student answered a question", null, true },
                    { 3, new DateTime(2022, 7, 31, 19, 33, 58, 511, DateTimeKind.Local).AddTicks(5901), "Your qustion was aproved", null, true }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "I", new DateTime(2022, 7, 31, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2022, 7, 31, 0, 0, 0, 0, DateTimeKind.Local), 34, "Alex", 5, "Mate" },
                    { 2, "II", new DateTime(2022, 7, 31, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2022, 7, 31, 0, 0, 0, 0, DateTimeKind.Local), 23, "Cosmin", 4, "Mate" },
                    { 3, "II", new DateTime(2022, 7, 31, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2022, 7, 31, 0, 0, 0, 0, DateTimeKind.Local), 23, "Cosmin", 4, "Info" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Email", "FirstName", "LastName", "Password", "isAdmin" },
                values: new object[,]
                {
                    { 1, "florin@gmail.com", "Florin", "Tarabas", "abcde", false },
                    { 2, "teo@gmail.com", "Teo", "Frunza", "qwer0", false }
                });
